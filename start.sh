# 默认测试单张图片
# ~/miniconda3/envs/mmclassification/bin/python cam.py --image-path examples/horses.jpg --method gradcam
...
# vit注意力可视化
~/miniconda3/envs/mmclassification/bin/python vit_example_wjf.py --image-path examples/both.png --method gradcam